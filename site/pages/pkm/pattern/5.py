...
def create_ruled_narrow_template(config):
    ...
    line_width = 1  # Thicker line width
    for y in np.arange(line_spacing_cm, size_cm[1], line_spacing_cm):
        ax.plot([0, size_cm[0]], [y, y], color='black', lw=line_width)
...
create_ruled_narrow_template(config['ruled_narrow'])
