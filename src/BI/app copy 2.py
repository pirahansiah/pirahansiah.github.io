...
def gather_metadata(folder_path):
    ...
    try:
        ...
        return pd.DataFrame(metadata), folder_info
    except Exception as e:
...
if __name__ == '__main__':
    ...
    metadata_df, folder_info = gather_metadata(folder_path)
    ...
    if metadata_df.empty:
        ...
        app.layout = html.Div([
            ...
            html.Div([
                ...
                html.P(f"Total Folders: {len(next(os.walk(folder_path))[1])}"),
                html.P(f"Total Files: {len(metadata_df)}")
            ]),
            html.Div([
                html.H2("Folder Info"),
                html.Table([
